    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"> XML Database-nya </h1>
                    </div>
                   <h4> Klik button dibawah ini untuk mengakses dokumen XML</h4>
                   <button type="button" class="btn btn-outline btn-success"><a href="api.xml">XML script</a></button>
                    <!-- /.col-lg-12 -->
                </div>
